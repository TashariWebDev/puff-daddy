...
<body>
    <div class="container px-2 mx-auto bg-white">
        <div class="flex justify-center items-center p-6 w-full bg-white">
            <div>
        ...
        <div class="container flex justify-center items-center mx-auto mt-6 h-32 bg-white leading-0">
