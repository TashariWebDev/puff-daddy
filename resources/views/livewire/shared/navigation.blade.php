<div class="z-50 pb-2 w-full text-right bg-white lg:fixed">
    ...
    <div class="flex space-x-4">
      @auth
        ...
        <div class="hidden sm:flex sm:items-center sm:ml-6">
          ...
          >
            <x-slot name="trigger">
              <button class="inline-flex items-center py-2 px-3 text-sm font-medium leading-4 text-gray-500 bg-white rounded-md border border-transparent transition duration-150 ease-in-out hover:text-gray-700 focus:outline-none">
                <div
  ...
  @auth
    @if(! request()->user()->isWholesale())
      <div class="py-1 px-1 w-screen lg:px-0 bg-slate-900">
        <div class="container flex justify-start mx-auto lg:justify-end">
          <a
              href="{{ route('wholesale-application-form') }}"
              wire:navigate
              class="text-green-400 hover:text-green-500"
          >
            <p class="hidden lg:block"> → Are you a reseller? Apply for a wholesale account
                                        today!</p>
            
            <span class="text-left lg:hidden">
           <p>→ Are you a reseller?</p>
          <p>Apply for a wholesale account today!</p>
        </span>
          </a>
        </div>
      </div>
