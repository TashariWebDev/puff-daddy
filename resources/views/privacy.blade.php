<x-base-layout>
  <div class="p-2 max-w-none lg:p-20 prose prose-teal prose-sm lg:prose-xl">
    ...
    <article class="break-keep">
        <h1 class="text-teal-400">Privacy policy</h1>
        <h4>Last updated - January {{ date('Y') }}</h4>
        <p>
        ...
        <p>
            ...
            Policy, terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, accessible
            at {{ config('app.url') }}
        </p>
        ...
        <p>
            ...
            to, your name, phone number, postal address (“Personal Information”).
        </p>
        <h3>Log Data</h3>
        <p>
        ...
        <p>
            ...
            behalf, to perform Service-related services or to assist us in analysing how our Service is used.
        </p>
        <p>
        ...
        <p>
            ...
            or
            guardian and you are aware that your Children has provided us with Personal Information, please contact us.
            If
            we discover that a Children under 18 has provided us with Personal Information, we will delete such
            information
